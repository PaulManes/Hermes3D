...
- Location: `src/lib/ssh/gateway-host.ts:157`
- Category: `credential-access`
...
- Location: `src/lib/ssh/gateway-host.ts:158`
- Category: `credential-access`
...
- Location: `src/lib/ssh/gateway-host.ts:160`
- Category: `credential-access`
- Evidence: `sshArgs.push(params.sshTarget, ...params.argv);`
- Review: Remove broad credential access or scope it to an explicit user-selected file with clear consent.

### HIGH — Host command-execution boundary

- Location: `src/lib/ssh/gateway-host.ts:162`
- Category: `command-execution`
